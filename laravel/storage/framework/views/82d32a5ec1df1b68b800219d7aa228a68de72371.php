<?php $home = app('App\Http\Controllers\HomeController'); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="button" onclick="<?php echo e($home::goToView('modules')); ?>">
                        Modules
                    </div>

                    <div class="button" onclick="<?php echo e($home::goToView('events')); ?>">
                        Events
                    </div>
                </div>
            </div>
